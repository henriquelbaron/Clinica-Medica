...
public class ConsultaControl {
    ...
    public void setPacienteLabel() {

    }

    public void clickComboBoxEspecialidadeListener() {

    }

    public void clickComboBoxMedicoListener() {

    }

    public void clickComboBoxSalaListener() {
